...
describe "AutocompleteGlsl", ->
  [workspaceElement, activationPromise] = []

  beforeEach ->
    workspaceElement = atom.views.getView(atom.workspace)
    activationPromise = atom.packages.activatePackage('autocomplete-glsl')

  describe "when the autocomplete-glsl:toggle event is triggered", ->
    it "hides and shows the modal panel", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'autocomplete-glsl:toggle'
        expect(autocompleteGlslPanel.isVisible()).toBe false
    ...
    it "hides and shows the view", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'autocomplete-glsl:toggle'
        expect(autocompleteGlslElement).not.toBeVisible()
